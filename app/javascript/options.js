...
$(document).on("click", ".add-user-to-contacts, .add-user-to-contacts-notif", function (e) {
  var conversation_window =
    $(this).parents(
      ".conversation-window,\
                                  .conversation"
    );
  conversation_window.find(".add-user-to-contacts").replaceWith(
    '<div class="contact-request-sent"\
              style="display: block;">\
             <div>\
  ...
  conversation_window.find(".messages_list ul").append(
